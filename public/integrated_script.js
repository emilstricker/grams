...
function initializePageSpecificFeatures() {
  ...
  if (calcButton) {
    calcButton.addEventListener('click', function () {
      ...
      const startDate = document.getElementById('startDate').value; // assuming this is a string
      const dietDuration = parseInt(document.getElementById('dietDuration').value);

      // Call calculatePlan function with input values
      const planResult = calculatePlan(startingWeight, goalWeight, startDate, dietDuration);
      console.log(planResult); // Do something with the result
    });
  }
